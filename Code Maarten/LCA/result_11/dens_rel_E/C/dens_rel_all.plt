...
plot "dens_rel.00.111.$1.-1" u (\$1):(\$4/norm) ls 1 w l ti '\$\bm{^{$2}}\$$1 TBC',\
"dens_rel.00.111.$1.-1" u (\$1):(\$2/norm) ls 10 w l ti "IPM",\
"dens_rel.00.111.$1.0" u (\$1):(\$4/norm) ls 2 w l ti "\$\\\bm{2n+l = 0}\$" ,\
"dens_rel.00.111.$1.1" u (\$1):(\$4/norm) ls 3 w l ti "\$\\\bm{2n+l = 1}\$" ,\
"dens_rel.00.111.$1.2" u (\$1):(\$4/norm) ls 4 w l ti "\$\\\bm{2n+l = 2}\$" ,\
"dens_rel.00.111.$1.3+" u (\$1):(\$2/norm) ls 5 w l ti "\$\\\bm{2n+l \\\geq 3}\$"
