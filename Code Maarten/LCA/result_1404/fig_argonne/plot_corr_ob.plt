...
"../".X."/dens_ob3.00.110.".X.".-1" u 1:(\$4)/A w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X.' LCA' ,\
"../".X."/dens_ob3.00.110.".X.".-1" u 1:(\$2)/A w l  ls 3 ti 'IPM',\
"../".X."/dens_ob3.00.110.".X.".0" u 1:(\$3)/A w l  ls 4 ti '\$\bm{2n+l=0}\$'
...
plot "be9.momentum.txt" i 0 u 1:((\$2)+(\$4))/19.7392088/A  ls 5 noti,\
"../".X."/dens_ob3.00.110.".X.".-1" u 1:(\$4)/A w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X.' LCA' ,\
"../".X."/dens_ob3.00.110.".X.".-1" u 1:(\$2)/A w l  ls 3 ti 'IPM',\
"../".X."/dens_ob3.00.110.".X.".0" u 1:(\$3)/A w l  ls 4 ti '\$\bm{2n+l=0}\$',\
"../".X."/dens_ob3.00.110.".X.".1" u 1:(\$3)/A w l  ls 6 ti '\$\bm{2n+l=1}\$',\
"../".X."/dens_ob3.00.110.".X.".2" u 1:(\$3)/A w l  ls 7 ti '\$\bm{2n+l=2}\$'
...
"../".X."/dens_ob3.00.110.".X.".1" u 1:(\$3)/A w l  ls 6 ti '\$\bm{2n+l=1}\$',\
"../".X."/dens_ob3.00.110.".X.".2" u 1:(\$3)/A w l  ls 7 ti '\$\bm{2n+l=2}\$',\
"../".X."/dens_ob3.00.110.".X.".3+" u 1:(\$3)/A w l  ls 8 ti '\$\bm{2n+l\geq3}\$'
