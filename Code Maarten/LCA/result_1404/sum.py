...
test_data= np.loadtxt("./{:s}/dens_ob3.00.110.{:s}.0".format(A,A))
X= test_data[:,0]
...
test_data= np.loadtxt("./{:s}/dens_ob3.00.110.{:s}.0.n".format(A,A))
X= test_data[:,0]
summf= np.zeros_like(X)
sumco= np.zeros_like(X)
sumZ= np.zeros_like(X)
...
test_data= np.loadtxt("./{:s}/dens_ob3.00.110.{:s}.0.p".format(A,A))
X= test_data[:,0]
summf= np.zeros_like(X)
sumco= np.zeros_like(X)
sumZ= np.zeros_like(X)
