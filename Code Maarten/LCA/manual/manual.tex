...
\begin{align*}
	j_l(x) &= \sqrt{ \frac{\pi}{2 x}} J_{l+\frac{1}{2}}(x) = \sqrt{ \frac{\pi}{2 x}} J_{l+\frac{1}{2}}(x) = \sqrt{ \frac{\pi}{2 x}} \sum_{k} \frac{ (-1)^{k}}{k! \Gamma(k+l+3/2)} \left(\frac{x}{2}\right)^{2k+l+1/2} \\
	L_{n}^{l+\frac{1}{2}}(x) &= \sum_{j} (-1)^{j} \left( \begin{array}{c} n + l +1/2 \\ n - j \end{array} \right) \frac{x^j}{j!}
\end{align*}
\begin{multline*}
	\phi_{n l m}(\vec{p}) = N_{nl} \sqrt{ \frac{2}{\pi}} (-i)^{l}  Y_{l m}(\Omega_p) \\
	\int \text{d}r \, r^{2}  \sqrt{ \frac{\pi}{2 p r}} \sum_{k} \frac{ (-1)^{k}}{k! \Gamma(k+l+3/2)} \left(\frac{p r}{2}\right)^{2k+l+1/2} r^{l}  e^{-\frac{\nu r^{2}}{2}}  \sum_{j} (-1)^{j} \left( \begin{array}{c} n + l +1/2 \\ n - j \end{array} \right) \frac{(\nu r^{2})^j}{j!} \\
	=  N_{nl} (-i)^{l}  Y_{l m}(\Omega_p) \sum_{k j} \frac{ (-1)^{k+j}}{k! j! \Gamma(k+l+3/2)} \left( \begin{array}{c} n + l +1/2 \\ n - j \end{array} \right) \nu^{j} 2^{- 2k - l -\frac{1}{2} } p^{2k+l}\\
	\int \text{d}r \, r^{2}  r^{2k+2l}  e^{-\frac{\nu r^{2}}{2}} r^{2j} \\
\end{multline*}
TODO: CONTINUE CORRECTING BELOW!!!!
Looking at the $r$ integral separately we have,
\begin{multline*}
	\int \text{d}r \, r^{2}  r^{2k+l-\frac{1}{2}}  e^{-\frac{\nu r^{2}}{2}} r^{2j} = \int \text{d}r \, r^{2k+2j+l+3/2} e^{-\frac{\nu r^{2}}{2}} = \left( \frac{2}{\nu} \right)^{\frac{1+2k+2j+l+3/2}{2}}  \int \text{d}r' \, r'^{2k+2j+l+3/2} e^{-r'^{2}} \\
	= \left( \frac{2}{\nu} \right)^{\frac{1+2k+2j+l+3/2}{2}} \frac{1}{2} \Gamma \left( \frac{2k + 2j+l+3/2 + 1}{2} \right)
\end{multline*}
\begin{multline*}
	\phi_{n l m}(\vec{p}) =  N_{nl} 4 \pi \sqrt{\pi} (-i)^{l}  Y_{l m}(\Omega_p) \sum_{k j} \frac{ (-1)^{k+j}}{k! j! \Gamma(k+l+3/2)} \left( \begin{array}{c} n + l +1/2 \\ n - j \end{array} \right) \\
	\nu^{-\frac{2k+l+3/2+1}{2}} 2^{ \frac{ 2j - 2k - l - 1/2}{2} } p^{2k+l-\frac{1}{2}} \Gamma \left( \frac{2k + 2j+l+3/2 + 1}{2} \right)
\end{multline*}
\end{document}
