...
"he4_qNN.table.txt" u 1:((\$2+2*\$4)/norm/19.7392088022)  ls 3 ti "AV18 result"

set output "$file-2.tex"

plot "sorted_dens_rel.00.110.$1.0" u (\$1):(\$5/norm) ls 2 w l ti '\$\bm{^{$2}}\$$1' ,\
"sorted_dens_rel.00.110.$1.0" u (\$1):(\$2/norm) ls 4 w l ti "MF" ,\
"sorted_dens_rel.00.110.$1.0" u (\$1):(\$3/norm) ls 5 w l ti "2B" ,\
"sorted_dens_rel.00.110.$1.0" u (\$1):(\$4/norm) ls 6 w l ti "3B" ,\
"he4_qNN.table.txt" u 1:((\$2+2*\$4)/norm/19.7392088022)  ls 3 ti "AV18 result"
...
pdflatex $file-2 > cout
rm $file-2-inc-eps-converted-to.pdf
rm $file-2-inc.eps
rm $file-2.{aux,log}
