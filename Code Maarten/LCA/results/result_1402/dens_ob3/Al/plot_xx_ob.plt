...
#set term postscript enhanced color "Allvetica, 25"
#set term postscript enhanced color "Alomputer-Modern-Roman, 30"

set style line 1 lt 1 lw 4 lc rgb "#000000"
set style line 2 lt 2 lw 6 lc rgb "#E41A1Al"
...
plot "dens_ob3.00.110.Al.-1" u 1:(\$2+\$3) w l ls 2 ti '\$\bm{^{27}}\$Al \$\bm{n^{[1]}(p)}\$' ,\
"dens_ob3.11.110.Al.-1" u 1:(\$2+\$3) w l  ls 3 ti 'pp' ,\
"dens_ob3.-1-1.110.Al.-1" u 1:(\$2+\$3) w l  ls 4 ti 'nn' ,\
"dens_ob3.-11.110.Al.-1" u 1:(\$2+\$3) w l  ls 5 ti 'pn' 
