...
plot "be9.momentum.txt" i 0 u 1:((\$2+\$4)/19.7392088)  ls 2 ti '\$\bm{^{9}}\$Be Argonne ' ,\
"dens_ob3.00.110.Be.-1" u 1:(\$2+\$3) w l ls 3 ti '\$\bm{n^{[1]}(p)}\$' ,\
"dens_ob3.00.110.Be.0" u 1:(\$2+\$3) w l  ls 4 ti '\$\bm{E = 0}\$',\
"dens_ob3.00.110.Be.1" u 1:(\$2+\$3) w l  ls 5 ti '\$\bm{E = 1}\$' ,\
"dens_ob3.00.110.Be.2" u 1:(\$2+\$3) w l  ls 6 ti '\$\bm{E = 2}\$'
