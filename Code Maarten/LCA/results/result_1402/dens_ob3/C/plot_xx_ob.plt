...
plot "dens_ob3.00.110.C.-1" u 1:(\$2+\$3) w l ls 2 ti '\$\bm{^{12}}\$C \$\bm{n^{[1]}(p)}\$' ,\
"dens_ob3.11.110.C.-1" u 1:(\$2+\$3) w l  ls 3 ti 'pp' ,\
"dens_ob3.-1-1.110.C.-1" u 1:(\$2+\$3) w l  ls 4 ti 'nn' ,\
"dens_ob3.-11.110.C.-1" u 1:(\$2+\$3) w l  ls 5 ti 'pn' 
