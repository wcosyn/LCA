...
plot "dens_ob3.00.110.".X.".-3" u 1:(\$2+\$3)/A w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X ,\
"dens_ob3.00.110.".X.".-3" u 1:(\$2)/A w l ls 3 ti 'IPM' ,\
"dens_ob3.00.100.".X.".-3" u 1:(\$3)/A w l  ls 4 ti 'central' ,\
"dens_ob3.00.010.".X.".-3" u 1:(\$3)/A w l  ls 5 ti 'tensor'
...
#plot "dens_ob3.00.110.".X.".-3" u 1:(\$2+\$3)/A w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X.' \$\bm{n^{[1]}(p)}\$' ,\
...
plot "dens_ob3.00.110.".X.".-3" u 1:(\$2+\$3)/A w l ls 2 ti '\$\bm{^{'.A.'}}\$'.Xkey ,\
"dens_ob3.00.110.".X.".-3" u 1:(\$2)/A w l ls 3 ti 'IPM' ,\
"dens_ob3.00.100.".X.".-3" u 1:(\$3)/A w l  ls 4 ti 'central' ,\
"dens_ob3.00.010.".X.".-3" u 1:(\$3)/A w l  ls 5 ti 'tensor'
