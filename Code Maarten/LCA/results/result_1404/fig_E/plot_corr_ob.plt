...
plot "../".X."/dens_ob3.00.110.".X.".-1" u 1:(f(\$4)/A) w l ls 2 ti '\$\bm{^{'.A.'}}\$'.Xkey.' LCA' ,\
  "../".X."/dens_ob3.00.110.".X.".-1" u 1:(f(\$2)/A) w l  ls 3 ti 'IPM',\
"../".X."/dens_ob3.00.110.".X.".0" u 1:(f(\$3)/A) w l  ls 4 ti '\$\bm{2n+l=0}\$',\
"../".X."/dens_ob3.00.110.".X.".1" u 1:(f(\$3)/A) w l  ls 6 ti '\$\bm{2n+l=1}\$',\
"../".X."/dens_ob3.00.110.".X.".2" u 1:(f(\$3)/A) w l  ls 7 ti '\$\bm{2n+l=2}\$',\
...
"../".X."/dens_ob4.00.110.".X.".0" u 1:(f(\$3)/A) w l  ls 4 ti '\$\bm{2n+l=0}\$',\
"../".X."/dens_ob4.00.110.".X.".1" u 1:(f(\$3)/A) w l  ls 6 ti '\$\bm{2n+l=1}\$',\
"../".X."/dens_ob4.00.110.".X.".2" u 1:(f(\$3)/A) w l  ls 7 ti '\$\bm{2n+l=2}\$',\
"../".X."/dens_ob4.00.110.".X.".3+" u 1:(f(\$3)/A) w l  ls 8 ti '\$\bm{2n+l\geq3}\$'
