...
"../".X."/dens_ob4.11.110.".X.".-1" u 1:(\$4)/A w l ls 3 ti 'pp' ,\
"../".X."/dens_ob4.-1-1.110.".X.".-1" u 1:(\$4)/A w l  ls 4 ti 'nn' ,\
"../".X."/dens_ob4.-11.110.".X.".-1" u 1:(\$4)/A w l  ls 5 ti 'pn'
...
"../".X."/dens_ob3.11.110.".X.".-1" u 1:(\$4)/A w l ls 3 ti 'pp' ,\
"../".X."/dens_ob3.-1-1.110.".X.".-1" u 1:(\$4)/A w l  ls 4 ti 'nn' ,\
"../".X."/dens_ob3.-11.110.".X.".-1" u 1:(\$4)/A w l  ls 5 ti 'pn'
...
"../".X."/dens_ob4b.11.110.".X.".-1" u 1:(\$4)/A w l ls 3 ti 'pp' ,\
"../".X."/dens_ob4b.-1-1.110.".X.".-1" u 1:(\$4)/A w l  ls 4 ti 'nn' ,\
"../".X."/dens_ob4b.-11.110.".X.".-1" u 1:(\$4)/A w l  ls 5 ti 'pn'
...
plot "dens_ratio.110.".X.".-1" u 1:2 w l ls 3 noti,\
"dens_ratio.110.".X.".-1" u 1:3 w l ls 4 noti,\
"dens_ratio.110.".X.".-1" u 1:4 w l ls 5 noti,\
"data" u (\$1)/hbarc:(1)/(2*\$2+1):(\$3)/hbarc:(\$4)/hbarc:(1)/(2*\$5+1):(1)/(2*\$6+1) with xyerrorbars ti "pn" ls 7,\
"data" u (\$1)/hbarc:(\$2)/(2*\$2+1):(\$3)/hbarc:(\$4)/hbarc:(\$5)/(2*\$5+1):(\$6)/(2*\$6+1) with xyerrorbars ti "pp" ls 6
...
"dens_ratio.110.".X.".-1" u 1:3 w l ls 4 noti,\
"dens_ratio.110.".X.".-1" u 1:4 w l ls 5 noti,\
"dataC" u (\$1)/hbarc:(\$2)/(\$2+2):(\$3)/hbarc:(\$4)/hbarc:(\$5)/(\$5+2):(\$6)/(\$6+2) with xyerrorbars ti "pn" ls 7,\
"dataC" u (\$1)/hbarc:(1)/(\$2+2):(\$3)/hbarc:(\$4)/hbarc:(1)/(\$5+2):(1)/(\$6+2) with xyerrorbars ti "pp" ls 6
