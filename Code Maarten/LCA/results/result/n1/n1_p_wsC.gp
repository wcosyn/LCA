...
#set format y "%2.0e"
plot \
"wsfits_kT.C" u ($1):($2):($3) with filledcurve ls 2 noti, \
"" u ($1):($2):($4) with filledcurve ls 2 noti, \
"" u ($1):($3):($4) with filledcurve ls 2 noti, \
"ws_n1_p_0_3.C" u ($1)*hbarc:($1)*($1)*($4)/hbarc ls 1 ti "^{12}C WS"

#"wsfits.C" u ($1)*hbarc:($2)/hbarc:($3)/hbarc with filledcurve ls 2 noti, \
#"" u ($1)*hbarc:($2)/hbarc:($4)/hbarc with filledcurve ls 2 noti, \
#"" u ($1)*hbarc:($3)/hbarc:($4)/hbarc with filledcurve ls 2 noti, \
#"ws_n1_p_0_3.C" u ($1)*hbarc:($1)*($1)*($4)/hbarc ls 1 ti "^{12}C WS"
