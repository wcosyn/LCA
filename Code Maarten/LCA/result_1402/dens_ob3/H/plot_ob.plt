...
plot "h2.momentum.txt" i 0 u 1:((\$4)*2/19.7392088)  ls 2 ti '\$\bm{^{2}}\$H - Argonne' ,\
  "dens_ob3.00.110.H.-1" u 1:(\$2+\$3) w l ls 3 ti '\$\bm{n^{[1]}(p)}\$' ,\
"dens_ob3.00.110.H.0" u 1:(\$2+\$3) w l  ls 4 ti '\$\bm{E=0}\$'
