...
#set term postscript enhanced color "Olvetica, 25"
...
plot "dens_ob3.00.110.O.-1" u 1:(\$2+\$3) w l ls 2 ti '\$\bm{^{16}}\$O \$\bm{n^{[1]}(\vec{p})}\$' ,\
"dens_ob3.00.110.O.-1" u 1:(\$2) w l ls 3 ti 'IPM' ,\
"dens_ob3.00.100.O.-1" u 1:(\$3) w l  ls 4 ti 'central' ,\
"dens_ob3.00.010.O.-1" u 1:(\$3) w l  ls 5 ti 'tensor'
