...
#plot "dens_ob3.00.110.O.-1" u 1:(\$3) w l ls 3 ti '\$\bm{^{16}}\$O TBC - p+n' ,\
#"dens_ob3.00.110.O.0" u 1:(\$3) w l  ls 4 ti "E = 0" ,\
#"dens_ob3.00.110.O.1" u 1:(\$3) w l  ls 5 ti "E = 1" ,\
#"dens_ob3.00.110.O.2" u 1:(\$3) w l  ls 6 ti "E = 2" 

plot "dens_ob3.00.110.O.-1" u 1:(\$2+\$3) w l ls 3 ti '\$\bm{^{16}}\$O \$\bm{n^{[1]}(p)}\$',\
"dens_ob3.00.110.O.0" u 1:(\$2+\$3) w l  ls 4 ti '\$\bm{E=0}\$',\
"dens_ob3.00.110.O.1" u 1:(\$2+\$3) w l  ls 5 ti '\$\bm{E=1}\$',\
"dens_ob3.00.110.O.2" u 1:(\$2+\$3) w l  ls 6 ti '\$\bm{E=2}\$'
