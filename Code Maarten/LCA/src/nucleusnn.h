...
private:
	virtual void makepairs();
         ...
         * Make nnn triplets
         */
	virtual void maketriplets(){ Nucleus::maketriplets(); };
        /**
         * Make nn-t3 triplets
         */
	virtual void maketriplets( int t3 ){ Nucleus::maketriplets( t3 ); };
	int getT1(){ return -1;};
	int getT2(){ return -1;};
	vector < Shell* >* getShells1() { return &Shell::shellsN;};
	vector < Shell* >* getShells2() { return &Shell::shellsN;};
	int getA1(){ return N;};
	int getA2(){ return N;};
};
