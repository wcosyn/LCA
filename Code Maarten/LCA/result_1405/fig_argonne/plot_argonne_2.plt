...
plot "he4_qNN.table.txt" i 0 u 1:(((\$2)+2*(\$4))/19.7392088/A/(A-1)*2)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
  "../dens_rel.00.110.".X.".-1" u 1:(\$5)/A/(A-1)*2 w l ls 3 ti 'LCA',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$2)/A/(A-1)*2 w l ls 4 ti 'IPM',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$3)/A/(A-1)*2 w l ls 5 ti '2b',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$4)/A/(A-1)*2 w l ls 6 ti '3b'
...
#'\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
  ...
  plot "be8_qNN.table.txt" i 0 u 1:(((\$2)+2*(\$4))/19.7392088/A/(A-1)*2)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
  "../dens_rel.00.110.".X.".-1" u 1:(\$5)/A/(A-1)*2 w l ls 3 ti 'LCA',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$2)/A/(A-1)*2 w l ls 4 ti 'IPM',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$3)/A/(A-1)*2 w l ls 5 ti '2b',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$4)/A/(A-1)*2 w l ls 6 ti '3b'
...
#  set horizontal margins for row
set tmargin at screen top(2)
set bmargin at screen bot(2)
...
plot "c12c_qNN.table.txt" i 0 u 1:(((\$2)+2*(\$4))/19.7392088/A/(A-1)*2)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
  "../dens_rel.00.110.".X.".-1" u 1:(\$5)/A/(A-1)*2 w l ls 3 ti 'LCA',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$2)/A/(A-1)*2 w l ls 4 ti 'IPM',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$3)/A/(A-1)*2 w l ls 5 ti '2b',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$4)/A/(A-1)*2 w l ls 6 ti '3b'
...
#  set horizontal margins for  column
set lmargin at screen left(1)
set rmargin at screen right(1)
#  set horizontal margins for row
...
plot "../dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(\$5)/A/(A-1)*2 w l ls 3 ti '\$\bm{^{'.A.'}}\$'.X.' LCA',\
  "../dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(\$2)/A/(A-1)*2 w l ls 4 ti 'IPM',\
  "../dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(\$3)/A/(A-1)*2 w l ls 5 ti '2b',\
  "../dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(\$4)/A/(A-1)*2 w l ls 6 ti '3b'
...
plot "../dens_rel.00.110.".X.".-1" u 1:(\$5)/A/(A-1)*2 w l ls 3 ti '\$\bm{^{'.A.'}}\$'.Xkey.' LCA',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$2)/A/(A-1)*2 w l ls 4 ti 'IPM',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$3)/A/(A-1)*2 w l ls 5 ti '2b',\
  "../dens_rel.00.110.".X.".-1" u 1:(\$4)/A/(A-1)*2 w l ls 6 ti '3b'
