...
set output "momdens.E$4.all.$1.eps"

plot "dens.E-1.$1" u ((\$1)/sqrt(2)):((\$2)*sqrt(8)) ls 2 w l ti "total" ,\
"dens_2b.E-1.$1" u ((\$1)/sqrt(2)):((\$2)*sqrt(8)) ls 6 w l ti "2b" ,\
"dens_2b.E$4.$1" u ((\$1)/sqrt(2)):((\$2)*sqrt(8)) ls 3 w l ti "2b E$4",\
