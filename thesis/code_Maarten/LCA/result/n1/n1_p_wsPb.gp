...
plot \
"wsfits_kT.Pb" u ($1):($2):($3) with filledcurve ls 6 noti, \
"" u ($1):($2):($4) with filledcurve ls 6 noti, \
"" u ($1):($3):($4) with filledcurve ls 6 noti, \
"ws_n1_p_0_3.Pb" u ($1)*hbarc:($1)*($1)*($4)/hbarc ls 5 ti "^{208}Pb WS"

#plot \
#"wsfits.Pb" u ($1)*hbarc:($2)/hbarc:($3)/hbarc with filledcurve ls 6 noti, \
#"" u ($1)*hbarc:($2)/hbarc:($4)/hbarc with filledcurve ls 6 noti, \
#"" u ($1)*hbarc:($3)/hbarc:($4)/hbarc with filledcurve ls 6 noti, \
#"ws_n1_p_0_3.Pb" u ($1)*hbarc:($1)*($1)*($4)/hbarc ls 5 ti "^{208}Pb WS"
