...
plot "sorted_dens_ob.00.110.Fe.-1" u 1:(\$2+\$3) w l ls 3 ti '\$\bm{^{56}}\$Fe TBC - p+n' ,\
"sorted_dens_ob.00.110.Fe.0" u 1:(\$2+\$3) w l  ls 4 ti "E = 0" ,\
"sorted_dens_ob.00.110.Fe.1" u 1:(\$2+\$3) w l  ls 5 ti "E = 1" ,\
"sorted_dens_ob.00.110.Fe.2" u 1:(\$2+\$3) w l  ls 6 ti "E = 2" ,\
"sorted_dens_ob.00.110.Fe.3" u 1:(\$2+\$3) w l  ls 7 ti "E = 3" ,\
"sorted_dens_ob.00.110.Fe.4" u 1:(\$2+\$3) w l  ls 8 ti "E = 4" 
