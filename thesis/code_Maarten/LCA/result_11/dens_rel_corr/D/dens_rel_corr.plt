...
plot "dens_rel.00.111.$1.-1" u (\$1):(\$2/norm) ls 2 w l ti '\$\bm{^{$2}}\$$1 mf' ,\
"dens_rel.00.100.$1.-1" u (\$1):(\$3/norm) ls 3 w l ti 'cen' ,\
"dens_rel.00.010.$1.-1" u (\$1):(\$3/norm) ls 4 w l ti 'ten' ,\
"dens_rel.00.001.$1.-1" u (\$1):(\$3/norm) ls 5 w l ti 'iso' ,\
"dens_rel.00.111.$1.-1" u (\$1):(\$4/norm) ls 6 w l ti 'all' ,\
'$1$2_qNN.table.txt' u 1:((\$2+2*(\$4))/norm/19.7392088) ls 7 ti 'Argonne'
