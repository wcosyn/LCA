...
plot "he4.momentum.txt" i 0 u 1:((\$2)*2/19.7392088)  ls 2 ti '\$\bm{^{4}}\$He Argonne - p+n' ,\
"sorted_dens_ob.00.110.He.-1" u 1:(\$2+\$3) w l ls 3 ti "TBC - p+n" ,\
"sorted_dens_ob.00.110.He.0" u 1:(\$2+\$3) w l  ls 4 ti "E = 0"
