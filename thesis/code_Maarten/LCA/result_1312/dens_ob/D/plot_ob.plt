...
plot "h2.momentum.txt" i 0 u 1:((\$4)*2/19.7392088)  ls 2 ti '\$\bm{^{2}}\$H Argonne - p+n' ,\
"sorted_dens_ob.00.110.D.-1" u 1:(\$2+\$3) w l ls 3 ti "TBC - p+n" ,\
"sorted_dens_ob.00.110.D.0" u 1:(\$2+\$3) w l  ls 4 ti "E = 0"
