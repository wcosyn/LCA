...
plot "be9.momentum.txt" i 0 u 1:((\$2+\$4)/19.7392088)  ls 2 ti '\$\bm{^{9}}\$Be Argonne - p+n' ,\
"sorted_dens_ob.00.110.Be.-1" u 1:(\$2+\$3) w l ls 3 ti "TBC - p+n" ,\
"sorted_dens_ob.00.110.Be.0" u 1:(\$2+\$3) w l  ls 4 ti "E = 0" ,\
"sorted_dens_ob.00.110.Be.1" u 1:(\$2+\$3) w l  ls 5 ti "E = 1" ,\
"sorted_dens_ob.00.110.Be.2" u 1:(\$2+\$3) w l  ls 6 ti "E = 2"
