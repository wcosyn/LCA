...
plot "./dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(f(\$5)/A/(A-1)*2) w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X.' LCA' ,\
  "" u 1:(f(\$2)/A/(A-1)*2) w l  ls 3 ti 'IPM',\
  "./dens_rel.00.110.".X.".0000.-1-1" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 4 ti '\$\bm{00,00}\$'
...
plot "./dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(f(\$5)/A/(A-1)*2) w l ls 2 ti '\$\bm{^{'.A.'}}\$'.X.' LCA' ,\
  "" u 1:(f(\$2)/A/(A-1)*2) w l  ls 3 ti 'IPM',\
  "./dens_rel.00.110.".X.".0000.-1-1" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 4 ti '\$\bm{00,00}\$' ,\
  "./dens_rel.00.110.".X.".diff" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 5 ti 'Other'
...
#  "./dens_rel.00.110.".X.".1010.-1-1" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 6 ti '\$\bm{10,10}\$' ,\
...
set lmargin at screen left(2)
set rmargin at screen right(2)
#  set horizontal margins for lasts row 
set tmargin at screen top(1)
set bmargin at screen bot(1)
...
plot "./dens_rel.00.110.".X.".-1-1-1-1.-1-1" u 1:(f(\$5)/A/(A-1)*2) w l ls 2 ti '\$\bm{^{'.A.'}}\$'.Xkey.' LCA' ,\
  "" u 1:(f(\$2)/A/(A-1)*2) w l  ls 3 ti 'IPM',\
  "./dens_rel.00.110.".X.".0000.-1-1" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 4 ti '\$\bm{00,00}\$' ,\
  "./dens_rel.00.110.".X.".1010.-1-1" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 6 ti '\$\bm{10,10}\$' ,\
  "./dens_rel.00.110.".X.".diff" u 1:(f(\$3+\$4)/A/(A-1)*2) w l  ls 5 ti 'Other'
