...
set style line 4 lt 2 lw 6 lc rgb "#4daf4a"
...
plot "he4.momentum.txt" i 0 u 1:((\$2)*2/19.7392088/A)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
"../dens_ob4.00.110.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 3 ti 'ce-te',\
"../dens_ob4.00.111.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 4 ti 'ce-te-si' 
...
plot "be9.momentum.txt" i 0 u 1:((\$2+\$4)/19.7392088/A)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
"../dens_ob4.00.110.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 3 ti 'ce-te',\
"../dens_ob4.00.111.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 4 ti 'ce-te-si' 
...
plot "c12.momentum.txt" i 0 u 1:((\$2)*2/19.7392088/A)  ls 2  ti '\$\bm{^{'.A.'}}\$'.X.' Argonne' ,\
"../dens_ob4.00.110.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 3 ti 'ce-te',\
"../dens_ob4.00.111.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 4 ti 'ce-te-si' 
...
plot "../dens_ob4.00.110.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 3 ti '\$\bm{^{'.A.'}}\$'.X.' ce-te',\
"../dens_ob4.00.111.".X.".-1-1-1-1" u 1:(\$4)/A w l ls 4 ti 'ce-te-si' 
