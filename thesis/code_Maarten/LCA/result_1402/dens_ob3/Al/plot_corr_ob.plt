...
plot "dens_ob3.00.110.Al.-1" u 1:(\$2+\$3) w l ls 2 ti '\$\bm{^{27}}\$Al \$\bm{n^{[1]}(\vec{p})}\$' ,\
"dens_ob3.00.110.Al.-1" u 1:(\$2) w l ls 3 ti 'IPM' ,\
"dens_ob3.00.100.Al.-1" u 1:(\$3) w l  ls 4 ti 'central' ,\
"dens_ob3.00.010.Al.-1" u 1:(\$3) w l  ls 5 ti 'tensor'
