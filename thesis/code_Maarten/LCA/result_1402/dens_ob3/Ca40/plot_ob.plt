...
plot "dens_ob3.00.110.Ca40.-1" u 1:(\$2+\$3) w l ls 3 ti '\$\bm{^{40}}\$Ca \$\bm{n^{[1]}(p)}\$' ,\
"dens_ob3.00.110.Ca40.0" u 1:(\$2+\$3) w l  ls 4 ti '\$\bm{E = 0}\$' ,\
"dens_ob3.00.110.Ca40.1" u 1:(\$2+\$3) w l  ls 5 ti '\$\bm{E = 1}\$' ,\
"dens_ob3.00.110.Ca40.2" u 1:(\$2+\$3) w l  ls 6 ti '\$\bm{E = 2}\$' ,\
"dens_ob3.00.110.Ca40.3+" u 1:(\$2+\$3) w l  ls 7 ti '\$\bm{E \geq 3}\$' 
