...
//#pragma omp parallel for schedule(dynamic, 1)
  for( int int_k= 0; int_k< 50; int_k++ )
  {
    ...
    delete cf0; delete cfc; delete cft; delete cfs;
  ...
  *int2b= integral;
  *int3b= integral_3b;
  delete ic; delete it; delete is; delete icc; delete itt; delete ict; delete iss;
  delete ics; delete its;
}
...
//      if( coefi->getperm() != coefj->getperm() ) continue;
      ...
      int S12A= coefi->getS12(); int S12B= coefj->getS12();
      int T12A= coefi->getT12(); int T12B= coefj->getT12();
      int MT12A= coefi->getMT12(); int MT12B= coefj->getMT12();
      double Tval= 1;
      if( Ts > -1 )
      {
      ...
      int n123A= coefi->getn123(); int n123B= coefj->getn123();
      int l123A= coefi->getl123(); int l123B= coefj->getl123();
      int ml123A= coefi->getml123(); int ml123B= coefj->getml123();
      ...
      double preifactor=1;
      int j12A= coefi->getj12(); int j12B= coefj->getj12();
      int mj12A= coefi->getmj12(); int mj12B= coefj->getmj12();
//      int S= coefi->getS12();
//      int T= coefi->getT12();
...
//      if( tc1->getMT12() != tc2->getMT12() ) return 0;
      ...
      int n123A= tc1->getn123(); int n123B= tc2->getn123();
      int l123A= tc1->getl123(); int l123B= tc2->getl123();
      int ml123A= tc1->getml123(); int ml123B= tc2->getml123();
      int n12A= tc1->getn12(); int n12B= tc2->getn12();
      int l12A= tc1->getl12(); int l12B= tc2->getl12();
      ...
      int j12A= tc1->getj12(); int j12B= tc2->getj12();
      int mj12A= tc1->getmj12(); int mj12B= tc2->getmj12();
      int S12A= tc1->getS12(); int S12B= tc2->getS12();
