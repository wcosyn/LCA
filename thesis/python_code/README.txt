...
5. full-shell.py berekent two-body total momentum distributie voor kernen met volledig gevulde schillen (N) (wood-saxon opvulling met Spin-orbit = HO opvulling) #probleem : normalisatie = 2

(2.) en (3.) werken niet dus heb ik eerst voor eenvoudigere gevallen geprobeerd (4. en 5.). Bij (5.) geeft hetzelfde als (4.) voor Helium maar voor zwaardere kernen is er nog een factor 2 in de normalisatie.