...
def hulp(n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, N, L, N_,l):
     key = (n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, N, L, N_,l)
     result = 0
...
def twobody(P,n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, l, i):
     result = 0
     for N in xrange(0, 2*n_1 + l_1 + 2*n_2 + l_2 + 1):
          for L in xrange(0, 2*n_1 + l_1 + 2*n_2 + l_2 + 1):
               ...
               for N_ in xrange(0, 2*n_1 + l_1 + 2*n_2 + l_2 + 1):
                    ...
                    if(P == 0):
                         result = result + (hulp(n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, N, L, N_,l)*a*b)
                    else:
                         key = (n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, N, L, N_,l)
                                   ...
                                   for s_1 in xrange(0,2):
                                        for s_2 in xrange(0,2):
                                             if(t_1 != t_2 or n_1 != n_2 or l_1 != l_2 or m_1 != m_2 or s_1 != s_2 or degen[lvl_2] != degen[lvl_1]):
                                                  result = result + a*b*c*d*twobody(P,n_1, l_1, m_1, s_1, t_1, n_2, l_2, m_2, s_2, t_2, i,l)
     return result       
...
for l in xrange(0,9):
     fn = "./total/{:s}_tb_total_".format(nuc[NUC]) + str(l)  + ".txt"
     f = open(fn, "w")
