...
for i in range(len(nuc)):
     ...
     if NORMALISATION_CONVENTION=="A":
          MF_norm = 1/A[i] # because in convention corr normed on 1, MF will be normed lower than 1, correct for this, divide by A[i] to get normed to A again
     ...
     f.close()
     ax.plot(k,MF/MF_norm,label=nuc[i],lw=3)         
