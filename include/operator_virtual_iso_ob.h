...
public:
    ...
    /*
     * THE FOLLOWING FUNCTION IS FOR UPDATING NU IN CALCULATIONS DURING FITTING
     */

    /**
     * \brief Updates value of nu for computation of norm with the a and b cofficients of hbaromega 
     *   generated by the fitcode
     *
     * @param x identifies x for fitcode function to draw value of a and b from
     * @param hard parameter needed to create objects
     */
