...
//  virtual double get_me_3b_corr_right( Tripletcoef* tc1, Tripletcoef* tc2, void* params, double val= 1);
    ...
    struct dens_rel_params {
        ...
        int S;
        int T;
        density_rel_integrand2* ic;
        density_rel_integrand2* it;
        density_rel_integrand2* is;
        density_rel_integrand2* icc;
        density_rel_integrand2* ict;
        density_rel_integrand2* ics;
        density_rel_integrand2* itt;
        density_rel_integrand2* its;
